...
<?php if (count($product)) { ?>	
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<!-- SKU -->
			<p><?php echo language('sku', $lang); ?>: <strong><?php echo $product->sku; ?></strong></p>
	...
	<div class="row">
		<div class="col-md-12">
			 <ul class="nav nav-tabs" role="tablist">
				...
				<li role="presentation" onclick="reloadFace()">
			...
			<div id="fb-root"></div>
				...
				<script>(function(d, s, id) {
					  ...
					  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&appId=<?php echo $settings->app_id; ?>&version=v2.0";
...
<div class="row">
	...
	<p><?php echo language('data_not_found_desc', $lang); ?></p>
</div>
<?php } ?>