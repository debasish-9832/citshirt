...
<div class="blog-page">
	...
	?>
		<hr>
			<h3><?php echo language('list_categories', $lang); ?></h3>
	...
	?>
	<hr>
	<h3><?php echo language('list_articles', $lang); ?></h3>
	<?php
			...
			<div class="row">
				<div class="col-md-12">
					<div class="post-meta">
						...
						<a class="btn btn-xs btn-primary pull-right" href="<?php echo site_url().'blog/post/'.$article->id.'-'.$article->slug; ?>"> <?php echo language('read_more', $lang);?> </a>
					</div>
				</div>
			</div>
		</div>
