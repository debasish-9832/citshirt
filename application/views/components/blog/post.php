...
<div class="blog-page post-page">
	...
	<div class="post-connect">
		<?php 
			...
			{	
				echo '<h4>'.language('list_new_article', $lang).'</h4>';
				foreach($list_article as $list)
				{
					...
					<span>
					<i class="fa fa-user"></i> ';
					echo language('by', $lang);
					echo '<a href="#"> '.$article->created.' </a>
					</span>';
					//read more.
					echo '<a class="btn btn-xs btn-primary pull-right" href="'.site_url().'blog/post/'.$list->id.'-'.$list->slug.'" title="'.$list->title.'"> '.language('read_more', $lang).'</a>';
