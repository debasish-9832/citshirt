...
|
*/
$config['base_url']	= 'http://localhost/tshirt/';
...
|
*/
$config['encryption_key'] = '5b7vMF3c8vPzxwsGXmcirLaXdqcT4YCl';
...
|
*/
$config['sess_cookie_name']		= 'dg_session';
$config['sess_expiration']		= 36000;
$config['sess_expire_on_close']	= FALSE;
$config['sess_encrypt_cookie']	= FALSE;
$config['sess_use_database']	= true;
$config['sess_table_name']		= 'dg_sessions';
