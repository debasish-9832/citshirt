...
<div class="tabpanel" role="tabpanel">
	...
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="tab-general">
			...
			<div class="form-group">
				<label class="col-sm-2"><?php echo lang('banner_option_adaptive_height_title');?></label> 
				<div class="col-sm-4">
					<?php
						...
						if(isset($settings['adaptiveHeight']))
							$default = $settings['adaptiveHeight'];
						else	
							$default = '';
						echo form_dropdown('setting[adaptiveHeight]', $adaptiveHeight, $default, 'class="form-control input-sm"');
					?>
				</div>
				<div class="col-sm-6">
					<p class="help-block" style="margin-top: 0px;"><?php echo lang('banner_option_adaptive_height_help');?></p>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="col-sm-2"><?php echo lang('banner_option_auto');?></label> 
				<div class="col-sm-4">
					<?php
						$auto = array(
							'true'=>lang('yes'),
				...
				<div class="col-sm-6">
					<p class="help-block" style="margin-top: 0px;"><?php echo lang('banner_option_auto_help');?></p>
				</div>
			</div>
			<div class="form-group">	
			...
			<div class="form-group">	
				<label class="col-sm-2"><?php echo lang('banner_option_speed_title');?></label> 
				<div class="col-sm-4">
				...
				<div class="col-sm-6">
					<p class="help-block" style="margin-top: 0px;"><?php echo lang('banner_option_speed_help');?></p>
				</div>
			</div>
			<div class="form-group">	
...
<script type="text/javascript">
	function bannerImg(images)
	{
		if(images.length > 0)
		{
			...
			html += '<div class="col-sm-2"><?php echo lang('image');?>';
			html += '</div>';
