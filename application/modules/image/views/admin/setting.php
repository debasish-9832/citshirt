...
<div class="tabpanel" role="tabpanel">
	...
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="tab-general">	
				...
				<div class="row">
					<div class="col-sm-4">
						<?php 
							...
							$animation = array(
								''=>lang('no'),
								'slideInDown'=>lang('image_admin_setting_top_to_bottom'),
								'slideInUp'=>lang('image_admin_setting_bottom_to_top'),
								'slideInLeft'=>lang('image_admin_setting_left_to_right'),
								'slideInRight'=>lang('image_admin_setting_right_to_left'),
								'zoomIn'=>lang('image_admin_setting_appear_center'),
							);
			...
			<div class="form-group">
				<label><?php echo lang('image_admin_setting_target');?></label>
				<div class="row">
					<div class="col-sm-4">
						<?php 
							$target = array(
								''=>lang('image_admin_setting_none'),
								'_sef'=>lang('image_admin_setting_sef'),
								'_blank'=>lang('image_admin_setting_blank')
							);
							if(isset($options->target))
								$target_data = $options->target;
							else
								$target_data = '';
							echo form_dropdown('options[target]', $target, $target_data, 'class="form-control input-sm"');
						?>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<label><?php echo lang('image_admin_setting_image_popup');?></label>
				<div class="row">
					<div class="col-sm-4">
						<?php 
							$popup = array(
							...
							if(isset($options->popup))
								$popup_data = $options->popup;
							else
								$popup_data = '';
							echo form_dropdown('options[popup]', $popup, $popup_data, 'class="form-control input-sm"');
						?>
					</div>
				</div>
			</div>
