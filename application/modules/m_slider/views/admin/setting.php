...
<div class="tabpanel" role="tabpanel">
	...
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="tab-general">
			...
			<div class="form-group">
				<label class="col-sm-2"><?php echo lang('slider_option_adaptive_height_title');?></label> 
				<div class="col-sm-4">
					<?php
				...
				<div class="col-sm-6">
					<p class="help-block" style="margin-top: 0px;"><?php echo lang('slider_option_adaptive_height_help');?></p>
				</div>
			</div>
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<select name="data[target][]" class="form-control input-sm">
													<option value=""><?php echo lang('slider_option_none');?></option>
...
<script type="text/javascript">
	...
	function add_item_m_slider()
	{
		...
		var html = e.html();
			...
			html += '<option value=""><?php echo lang('slider_option_none');?></option>';
