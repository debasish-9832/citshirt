...
class Coupon extends Admin_Controller
{
	...
	public function index ()
	{
		...
		// Fetch all users
		$this->data['coupons'] = $this->coupon_m->getCoupons(false, $this->session->userdata('search_counpon'), $this->session->userdata('option_counpon'), $config['per_page'], $this->uri->segment(4));
