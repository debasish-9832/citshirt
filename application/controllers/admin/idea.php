...
class Idea extends Admin_Controller
{
	...
	public function index ($page = 0)
	{
		...
		$this->load->model('idea_m');
		$items	= $this->idea_m->getDesigns(false, $page, $this->session->userdata('search_idea'), $config['per_page']);		
	...
	public function save()
	{
		...
		else
		{
			...
			$data['slug']	= url_title(strtolower($data['slug']));
			...
			else
			{
				...
				$this->session->set_flashdata('msg', lang('idea_admin_design_template_add_success'));
			}
		}
